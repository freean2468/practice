...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/ka_web_page/css/common.css">
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/ka_web_page/notice/css/notice.css">
		<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/ka_web_page/notice/js/notice.js"></script>
	...
	<body>
		...
		<section>
            ...
            <?php include_once $_SERVER['DOCUMENT_ROOT'] . "/ka_web_page/db/db_connect.php"; ?>
			<div id="notice_box">
				<h3 id="notice_title">
					공지사항 > 수정하기
				</h3>
